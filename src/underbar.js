...
(function() {
  ...
  _.filter = function(collection, iterator) {
    ...
    _.each(collection, function(value) {
      iterator(value) && results.push(value);
    });
    return results;
  };
  ...
  _.map = function(array, iterator) {
    ...
    var results = [];
    _.each(array, function(val, key, collection){
  ...
  _.invoke = function(list, methodName, args) {
    return _.map(list, function(value, key, list){
       return typeof methodName === 'string' ? value[methodName]() : methodName.apply(value,args);
    });
  };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function (pass, value){
      return Boolean(pass && iterator(value));
    }, true);
  };
  ...
  _.defaults = function(obj) {
    _.each(arguments, function(arg, index){
      _.each(arg, function(data, key){
        obj.hasOwnProperty(key) || (obj[key] = data);
      });
    });
    return obj;
  };
  ...
  _.delay = function(func, wait) {
    ...
    debugger;
    var delayedFunc = function(){ func.apply(this,args); }
